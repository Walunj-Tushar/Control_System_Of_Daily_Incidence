    ...
    <div class="wrapper">
      ...
      <header class="main-header hidden-print"><a class="logo" href="index.html">Police</a>
        <nav class="navbar navbar-static-top">
          ...
          <div class="navbar-custom-menu">
            <ul class="top-nav">
                       <li>
                	<a href="OfficerLogin.jsp"><i class="fa fa-sign-out fa-fw"></i></a>
                </li>                </ul>
              </li>
            </ul>
          </div>
      ...
      <aside class="main-sidebar hidden-print">
        ...
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i>Complaints Details</h1>
            <p></p>
          </div>
          <div>
        ...
        <sql:query dataSource="${dbsource}" var="result">
        		Select *  from sendpeoplecomplaint where offid='12'
        	...
        	<tr  style="color: black">
        		...
        		<td><a href="javascript:confirmGo('Sure to change the status to Solved ?','OfficerSolveComplaint.jsp?id=<c:out value="${rows.id}"/>')"><u><font  color="green">Solved</font></u></a>&nbsp;&nbsp;&nbsp;&nbsp;
        		 <br>
        		<a href="javascript:confirmGo('Sure to change the status to In Progress ?','OfficercomplaintProgress.jsp?id=<c:out value="${rows.id}"/>')"><u><font  color="red">InProgress</font></u></a></td>
