		...
		<body>	
			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="#plan">View Rides</a></li>
			...
			<section class="banner-area relative" id="home">
				...
				<div class="row d-flex align-items-left">
							<div class="counter-left col-lg- col-md-">
							<div class="single-facts">
								<h1 class="counter">880</h1>
								<p><h6>Rides Completed</p>							
							</div>
						...
						<form  action="CustomerLogin" method="post" name="Customerlogin" id="Customerlogin" />
							...
							<div class="clearfix">
							<button class="primary-btn header-btn text-uppercase" type="submit">Login Click Here</span></button>
							<nav id="nav-menu-container">
				       <ul class="nav-menu">
				          <h2>For New Registration<a href="#Registration"><h6>Click Here</h6></a></h2>
						</ul>
				      </nav><!-- #nav-menu-container -->		   
			...
			<section class="faq-area section-gap" id="Registration">
				<div class="container">
									
					<div class="row d-flex align-items-center">
						<div class="counter-left col-lg-2 col-md-2">
							<div class="single-facts">
						...
						<div class="faq-content col-lg-10 col-md-10">
							<div class="single-faq">
								...
								<p>
								<div class="title text-center">
								<h1 class="mb-10">Enter Your Details For Registration</h1>
								<p>Car shearing with eco friendly system.</p>
