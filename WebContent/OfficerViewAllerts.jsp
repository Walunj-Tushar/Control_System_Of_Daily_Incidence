 ...
 <li class="dropdown notification-menu"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-user"></i></a>
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          <div class="user-panel">
            <div class="pull-left image"><img class="img-circle" src="images/p1.jpg" alt="User Image"></div>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i>View Alerts</h1>
            <p></p>
          </div>
        ...
        <sql:query dataSource="${dbsource}" var="result">
        		Select * from usersendallerts where offid=<%=id %>
        </sql:query>
