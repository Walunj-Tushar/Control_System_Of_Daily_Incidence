...
<title>Control System OF Daily Incidence</title>
				...
				function userlogin1()
		{
			...
			var pincode=document.userlogin.pincode.value;
			var id=document.userlogin.id.value;
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">											<div class="space-6"></div>
												<form  action="adminlogin" method="post" name="userlogin" id="userlogin" onsubmit="return userlogin1()"/>
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" name="pincode" id="pincode" placeholder="Password" />
										...
										<a href="AdminRegistration.jsp"> Sign Up	</a><a>
                                           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                           <a href="#">
