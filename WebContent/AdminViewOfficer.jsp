    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print">
        ...
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i> Officer Details In  <%=pincode %> Area </h1>
            <p></p>
          </div>
          <div>
        ...
        <sql:query dataSource="${dbsource}" var="result">
        		Select *  from officerreg where offpincode=<%=pincode %>
        </sql:query>
        	...
        	<tr  style="color: black">
        		...
        		<td><a href="javascript:confirmGo('Sure to activate this Officer ?','OfficerActive.jsp?id=<c:out value="${rows.id}"/>')"><u><font  color="black"><i class="fa fa-unlock"></i> Activate</font></u></a><br>
        		 
        		<a href="javascript:confirmGo('Sure to deactivate this Officer ?','OfficerDeactive.jsp?id=<c:out value="${rows.id}"/>')"><u><font  color="black"><i class="fa fa-lock"></i> Deactivate</font></u></a></td>
