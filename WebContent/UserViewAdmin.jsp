      ...
      <aside class="main-sidebar hidden-print">
        ...
        <sql:query dataSource="${dbsource}" var="result">
        	...
        	<tr  style="color: black">
        		...
        		<td><c:out value="${rows.mobileno}" /></td>
        		<td><a target=blank href="https://www.google.co.in/maps?q=<c:out value="${rows.pincode}" />"><c:out value="${rows.pincode}" /></td>
				...
				<td><a href="javascript:confirmGo('Sure to activate this Officer ?','AdminActive.jsp?id=<c:out value="${rows.id}"/>')"><u><font  color="black"><i class="fa fa-unlock"></i> Activate</font></u></a><br>
        		 
        		<a href="javascript:confirmGo('Sure to deactivate this Officer ?','AdminDeactive.jsp?id=<c:out value="${rows.id}"/>')"><u><font  color="black"><i class="fa fa-lock"></i> Deactivate</font></u></a></td>
