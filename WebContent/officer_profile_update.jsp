		...
		function clearText(field)
{
    if (field.defaultValue == field.value) field.value = '';
		...
		var post=document.offlogin.post.value;
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="active"><a href="OfficerHome.jsp"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
             ...
             <li class="treeview"><a href="OfficerAboutUs.jsp?na=<%=id1 %>"><i class="fa fa-file-text"></i><span>About Us</span><i class=""></i></a>
                <li class="treeview"><a href="OfficerContactUs.jsp?na=<%=id1 %>"><i class="fa fa-file-text"></i><span>Contact Us</span><i class=""></i></a>
      ...
      <div class="content-wrapper">
        ...
        <%@  page  import="java.sql.*"  %>
			<%
      			...
      			String fname="", mname="", lname="", adharno="",post="", state="", district="", taluka="", mno="";
			    Connection con=null;
      		try
        		{
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="officerprofileEdit.jsp" method="post" name="offlogin" id="offlogin" onsubmit="return officer()"/>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input class="form-control" value="<%=post %>" name="post" id="post" type="text" >
                  </div>
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input class="form-control"  value="<%=mno %>" name="mno" id="mno" type="text" >
                  </div>
