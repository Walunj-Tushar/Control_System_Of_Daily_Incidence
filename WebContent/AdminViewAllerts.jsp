    ...
    <div class="wrapper">
          ...
          <div class="navbar-custom-menu">
            <ul class="top-nav">
              <!--Notification Menu-->
               ...
               <li>
                	<a href="index.jsp"><i class="fa fa-sign-out fa-fw"></i></a>
                </li>
                      </ul>
              </li>
              </li>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i> Alerts Of More Requirement</h1>
        ...
        <sql:query dataSource="${dbsource}" var="result">
        		Select * from officersendallerts where pincode=<%=pincode %>
        </sql:query>
