 ...
 <%
  ...
  <body class="sidebar-mini fixed">
    <%@  page  import="java.sql.*"  %>
			...
			String name="", mobno="", incidenceaddr="",date="", time="", incidencedetails="";
			    Connection con=null;
      		try
        		{
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-edit"></i><span>Forms</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                ...
                <li><a href="AdminSendAllerts.jsp?na=<%=pincode%>"><i class="fa fa-circle-o"></i> Send Alerts</a></li>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit"></i>Allocate Officer to Complaint <%=id %></h1>
            </div>
          ...
          <div class="col-md-12">
      		...
      		try
        		{
            		Class.forName("com.mysql.jdbc.Driver");
            		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/controlsystem", "root", "9096605223");           
            		String query="SELECT DISTINCT COUNT(STATUS) FROM sendpeoplecomplaint where status="+0+" GROUP BY(offid)  ";
			...
			%>
                <div class="form-group">
                    <label class="control-label">Incidence Details</label>
                    <input class="form-control" value="COUNT(STATUS)" name="incidencedetails" type="text" >
                  </div>
