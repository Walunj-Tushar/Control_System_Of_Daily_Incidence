			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="#plan" target="blank">Plan</a></li>
				          <li><a href="#service">Service</a></li>
				          <li><a href="#contact">Contact</a></li>
				          <li><a href="#about">About</a></li>
				          <li><a href="https://www.google.com/maps/@18.8154266,74.5339326,7z" target="blank">Map</a></li>
				          <li><a href="#profile">Profile</a></li>
				          <li class="menu-has-children"><a href="">BOOK NOW</a>
				            <ul>
				              <li><a href="">Charter Cab</a></li>
				              <li><a href="">Shared Cab</a></li>
				              <li><a href="">Other Cab</a></li>
				            </ul>
				          </li>
...
<!-- start contact Area -->		
			...
			<section class="faq-area section-gap" id="profile">
				<div class="container">
			...
			%>
				<table border="1" align="center" class="table" style="border-color:#00FF00 ">
			...
			%>
							<tr style="color:#000000 " >
								...
								<td><button><a href="#up?id=<%=id %>" style="color:green;"><i class="fa fa-edit"></i> Edit</a></button> </td>
