    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print">
        ...
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i> Send Alert To Officer s <%=pincode %>  </h1>
        ...
        <sql:query dataSource="${dbsource}" var="result">
        	...
        	<tr  style="color: black">
        		...
        		<td>	<button display:"none"><a href="AdminSendAlert1.jsp?id=<c:out value="${rows.id}" />"  style="color:green;"><i class="fa fa-"></i>Send Alert </a></button> </td>
        		</td>
