      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="active"><a href="UserHome.jsp?na=<%=pincode%>"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
          ...
          <div class="col-md-12">
			...
			%>
               <div class="form-group">
         	   <label class="col-lg-2 control-label" for="inputEmail">Select Officer ID</label><br>
